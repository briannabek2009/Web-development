...
*/
function recArea(){
let length = doucument.getElementById("length");
let width = doucument.getElementById("width");
let output= donucment.getElementById("output");

let area = parseFloat ("length.value") * ("width.value");
